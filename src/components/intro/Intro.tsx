  ...
  return (
    <section className="min-h-[600px] flex flex-col items-center justify-center w-full gap-[10px] bg-[rgba(22,22,23,255)] p-[40px]">
        <div className="flex w-full md:w-[60%] flex-col items-center gap-[10px]">
            ...
            <p className="text-[#7f7f80] text-[clamp(1rem,2vw,1.2rem)] text-center lg:text-left font-semibold"> HEXAMAXIMAL offers a comprehensive DeFi solution that lets you <br className="lg:inline hidden" /> maintain your capital while spending only the yield you generate. </p>
        </div>
